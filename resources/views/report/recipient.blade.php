...
@section('body-content')
            ...
            <h1 class="title-text">Bank Transfer Report</h1>
            ...
            <div class="leftpan">
                <div class="service_panel panel panel-body">
                    <form action="{{url('/bank/reports')}}" class="row range_serch">
                        <div class="col-md-3">
                        ...
                        @foreach($reports as $report)
                            ...
                            @if(session('extra_permissions')['metroreport_view'] == 1)
                                ...
                                <tr class="{{$report['risk']}}">
                                    ...
                                    <td><a href="{{url('/')}}/recipient/reports/{{$report['id']}}"
                                           class="status-btn {{strtolower($report['status'])}}-color">{{$report['status']}}</a>
                                    </td>
                                </tr>
                            @endif
                            <?php
