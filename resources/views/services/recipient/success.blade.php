        ...
        <div class="container">
            ...
            <div class="leftpan row">
                    <div class="col-md-offset-2 col-md-8">
                        ...
                        <a href="{{url('/')}}/invoice/{{$metrorecipient['id']}}/1" target="_blank" id="invoiceprint" class="submitbtn">PRINT</a>
                    </div>
            </div>
        </div>
    </div>
    {{--<div style="display:none">
        <div id="metroprintable" style="text-align:center;">
            ...
            <div class="details-report">
                ...
                MSP ID: {{$metrorecipient['msp_id']}}<br>
                ...
                Transaction Type : {{$metrorecipient['transfer_mode']}} <br><br>
