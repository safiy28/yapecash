...
@section('body-content')
    ...
    <form method="POST" action="{{ route('nepal.reload.confirm') }}">
        <div class="leftpan">
            <div class="row">
                <div class="col-md-8">
                        ...
                        <div class="panelcontent">
                            <div class="col-md-4">
                                <div class="form-group clearfix">
                                    <input type="number" value="{{$amount ?? ''}}" name="amount" required placeholder="Enter Your Amount" readonly class="form-control">

                                </div>
                            </div>
                            <div class="col-md-2">
                                <span for="" class="label-info label">NPR</span>
                            </div>
                        </div>
                    </div>
