...
@section('body-content')
    ...
    <form id="confirm" role="form" method="POST" action="{{ url('/')}}/users/{{$user_id}}/recipient/insidecreate" accept-charset="UTF-8" >
        ...
        <input id="btn" type="submit" name="" value="Add" class="submitbtn" onClick="clearform();">
    </form>
    </div>
    </div>
@stop
